...
void EventEmitter::sendEvents(Widget* widget)
{
...
MouseMoveEvent EventEmitter::convertMove(const sf::Event& sf_event) const
{
...
MousePressedEvent EventEmitter::convertMousePressed(
...
MouseReleasedEvent EventEmitter::convertMouseReleased(
    const sf::Event& sf_event) const
{
...
KeyboardPressedEvent EventEmitter::convertKeyPressed(
    const sf::Event& sf_event) const
{
...
KeyboardReleasedEvent EventEmitter::convertKeyReleased(
    const sf::Event& sf_event) const
{
...
TickEvent EventEmitter::makeTickEvent(void)
{
